...
// Try to include actual headers for types, if they exist
#ifdef __has_include
#if __has_include("../../buffer/inc/zoo_list.h")
#include "../../buffer/inc/zoo_list.h"
#else
// Fallback definitions if headers not available
typedef void* ZOO_LIST_HANDLE;
#endif
#else
// Fallback definitions if __has_include not supported
typedef void* ZOO_LIST_HANDLE;
#endif
