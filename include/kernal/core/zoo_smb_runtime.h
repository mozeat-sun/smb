...
#include "domain/zoo_domain_profile.h"
    ...
    typedef struct
    {
        ...
        ZOO_BOOL domain_profile_override_enabled; /**< Use runtime-provided profile instead of compile-time profile */
        ZOO_DOMAIN_PROFILE_ENUM domain_profile_override; /**< Runtime-selected domain profile when override is enabled */
