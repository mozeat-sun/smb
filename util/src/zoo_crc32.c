...
// Standard reflected CRC32 table for polynomial 0xEDB88320
static const ZOO_UINT32 crc32_table[256] = {
 ...
 *
 * This function computes the CRC32 (Cyclic Redundancy Check) value for the specified
 * block of memory. It is commonly used for error-checking in data transmission and storage.
 *
...
ZOO_UINT32 zoo_calc_crc32(const void* data, ZOO_SIZE_T size)
{
    ...
    ZOO_UINT32 result = crc ^ 0xFFFFFFFF;
    return result;
}