...
RELEASE_CHECKLIST_FILE="${RELEASE_CHECKLIST_FILE:-docs/release/records/M3-RC1_EXECUTION_CHECKLIST.md}"
LONG_SOAK_EVIDENCE_FILE="${LONG_SOAK_EVIDENCE_FILE:-docs/release/records/GRADE1_LONG_SOAK_EVIDENCE.json}"
PILOT_EVIDENCE_FILE="${PILOT_EVIDENCE_FILE:-docs/release/records/GRADE1_PRODUCTION_PILOT_EVIDENCE.md}"
