...
- `docs/releases/M3-RC1_RELEASE_NOTES.md`
- `docs/releases/M3-RC1_EXECUTION_CHECKLIST.md`
- `docs/releases/M3-RC1_ASSESSOR_PACKAGE_MANIFEST.md`
- `docs/releases/M3-RC1_INDEPENDENT_SAFETY_REVIEW.md`
