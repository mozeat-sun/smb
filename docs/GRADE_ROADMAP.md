...
- Release scorecard template: `docs/RELEASE_QUALITY_SCORECARD.md`
- Audit evidence checklist: `docs/AUDIT_ARTIFACT_CHECKLIST.md`
- Requirements catalog: `docs/REQUIREMENTS_CATALOG.md`
- Traceability guide: `docs/TRACEABILITY_GUIDE.md`
- Benchmark baseline process: `docs/BENCHMARK_BASELINE_PROCESS.md`
