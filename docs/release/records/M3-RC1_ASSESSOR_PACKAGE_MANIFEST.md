...
|---|---|---|---|
| Release scorecard | `docs/release/process/RELEASE_QUALITY_SCORECARD.md` | Included | Records `Go` decision for M3-RC1 |
| Release notes | `docs/release/records/M3-RC1_RELEASE_NOTES.md` | Included | Candidate compatibility and limitations declared |
| Execution checklist | `docs/release/records/M3-RC1_EXECUTION_CHECKLIST.md` | Included | Updated with current completion status |
| Evidence freeze record | `docs/release/records/M3-RC1_EVIDENCE_FREEZE_RECORD.md` | Included | Current local freeze record |
| Independent review record | `docs/release/records/M3-RC1_INDEPENDENT_SAFETY_REVIEW.md` | Included | Pre-review completed with actions |
| Safety case skeleton | `docs/assurance/SAFETY_CASE_SKELETON.md` | Included | M4 package structure baseline |
| Toolchain and change control | `docs/requirements/TOOLCHAIN_BASELINE_AND_CHANGE_CONTROL.md` | Included | Controlled baseline policy |
...
| Item | Path | Status | Notes |
|---|---|---|---|
| Pre-assessment findings log | `docs/readiness/PRE_ASSESSMENT_FINDINGS_LOG.csv` | Included | Internal round `INT-R1-2026-04-16` with owners, target dates, and remediation notes |
| Pre-assessment readiness summary | `docs/readiness/PRE_ASSESSMENT_READINESS_SUMMARY.md` | Included | Published stakeholder summary for internal round `INT-R1-2026-04-16` |
| Grade 1 exit checklist | `docs/assurance/GRADE1_EXIT_CHECKLIST.md` | Included | Defines Grade 1 gate IDs, evidence paths, and repository scope boundary |
| Grade 1 long-soak evidence intake | `docs/release/records/GRADE1_LONG_SOAK_EVIDENCE.json` | Included (template) | Intake record for independently operated 30-day soak evidence used by gate `G1-REL-001` |
| Grade 1 production pilot evidence intake | `docs/release/records/GRADE1_PRODUCTION_PILOT_EVIDENCE.md` | Included (template) | Intake record for external-user pilot evidence used by gate `G1-EXIT-003` |
