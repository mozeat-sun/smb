...
- Required mitigations: Execute [docs/release/records/M3-RC1_EXECUTION_CHECKLIST.md](docs/release/records/M3-RC1_EXECUTION_CHECKLIST.md), run the full CI workflow on the release commit, and archive the generated artifacts alongside [docs/release/records/M3-RC1_RELEASE_NOTES.md](docs/release/records/M3-RC1_RELEASE_NOTES.md).
